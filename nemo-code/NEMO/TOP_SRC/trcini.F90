...
#  include "domzgr_substitute.h90"
   ...
   !! $Id: trcini.F90 6606 2016-05-23 15:06:46Z cetlod $ 
...
CONTAINS
   ...
   SUBROUTINE trc_init
      ...
      REAL(wp), POINTER, DIMENSION(:,:,:,:) :: ztrcdta
      !!---------------------------------------------------------------------
      !
      ...
      ELSE
        ...
        IF( ln_trcdta .AND. nb_trcdta > 0 ) THEN  ! Initialisation of tracer from a file that may also be used for damping
            !
            CALL wrk_alloc( jpi, jpj, jpk, nb_trcdta, ztrcdta )
            !
